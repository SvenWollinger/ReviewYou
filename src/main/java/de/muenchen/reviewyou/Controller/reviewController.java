    ...
    public reviewController() {
        ...
        ActionListener actionListenerCalculate = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                double totalscore = ( question1Points + question2Points + question3Points + question4Points + question5Points +
        ...
        if(totalscore > 8){
            String OverallAssessment = "Geeignet";

        }else{
            String OverallAssessment = "Ungeeignet";
        }
)
